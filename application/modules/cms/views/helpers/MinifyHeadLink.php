...
class Zend_View_Helper_MinifyHeadLink extends Zend_View_Helper_HeadLink {
	...
	/**
	 * 
	 * Minify output. Default is true
	 * @var boolean 
	 */
	protected $_doMinify = TRUE;
	...
	public function toString($indent = null) {
		if(!$this->_doMinify){
			return parent::toString($indent); // Do not minify output
		}
	...
	/**
	 * Minify output or not
	 * 
	 * @param boolean $doMinify 
	 * @return \Zend_View_Helper_MinifyHeadLink
	 */
	public function doMinify($doMinify) {
		$this->_doMinify = $doMinify;
		return $this;
	}
}